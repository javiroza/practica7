...
# Títol del gràfic
set title "{/Symbol q}(t) grans oscil·lacions"
...
# Plot 
plot "P7-1920-resf.dat" index 2 using 1:2 with points t "Euler", \
"P7-1920-resf.dat" index 3 using 1:2 with points t "Predictor-Corrector"
#pause -1
